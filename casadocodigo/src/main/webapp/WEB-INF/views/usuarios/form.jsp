...
<body> 
	...
	<div class="container">
		...
		<form:form action="${s:mvcUrl('UC#salvar').build() }" method="post" commandName="usuario" enctype="multipart/form-data">
			...
			<div class="form-group">
				...
				<form:password path="confirmacaoSenha" cssClass="form-control" />
